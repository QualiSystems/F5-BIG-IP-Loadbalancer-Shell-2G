...
# **F5 BIG-IP Loadbalancer Shell 2G**
...
### **F5 BIG-IP Loadbalancer Shell 2G**
The **F5 BIG-IP Loadbalancer Shell 2G** shell provides you with connectivity and management capabilities such as device structure discovery and power management for the resource.

For more information on the device, see the vendor's official product documentation.

### Standard version
**F5 BIG-IP Loadbalancer Shell 2G** is based on the Load Balancer Shell Standard version **1.0.0**.
...
Release: **F5 BIG-IP Loadbalancer Shell 2G**
...
#### **F5 BIG-IP Loadbalancer Shell 2G Attributes**
...
The **F5 BIG-IP Loadbalancer Shell 2G** shell is available from the [Quali Community Integrations](https://community.quali.com/integrations) page.
...
1. Download the *cloudshell-loadbalancer-f5-bigip-dependencies-package-1.0.x.zip* file, see [Downloading the Shell](#downloading-the-shell).
...
For release updates, see the shell's [GitHub releases page](https://github.com/QualiSystems/F5-BigIp-Loadbalancer-Shell-2G/releases).
